...
#
# typical usage: tar_projects.sh  && echo "exit code is $?"
#
...
TAR_FILE_NAME="${HOSTNAME}_projects_${DATE}.tar.gz"
...
help() {
    echo -e "\n$0 usage:"
    echo -e "\t./tar_projects.sh [-v|--verbose -h|--help]"
